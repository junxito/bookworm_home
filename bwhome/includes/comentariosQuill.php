...
<body>
    ...
    <div style="width: 100%; text-align: center;">
        <input type="text" name="comentario" id="comentario" hidden>
        <input type="text" name="finalEstrellas" id="finalEstrellas" hidden>
        <input type="submit" class="btn btn-primary btn-sm text-dark" name="botonComentario" aria-label="Close" onclick="getQuillValue(), getRating()" value="Enviar Comentario" />
    </div>
