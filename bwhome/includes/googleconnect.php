  ...
  if (!isset($token['error'])) {
    ...
    if (!$resultado = $conn->query($sql)) {
      ...
      if ($resultado->num_rows > 0) {
        ...
        if ($user = UsuarioController::fetchUsuario($_SESSION['user_email_address'])) {
...
if (!isset($_SESSION['access_token'])) {
  ...
  $login_button = '<a href="' . $google_client->createAuthUrl() . '"><img src="../assets/img/logo-Google.png" width="150px" alt="Inicio de sesión con Google" class="googlebtn"/></a>';
}
